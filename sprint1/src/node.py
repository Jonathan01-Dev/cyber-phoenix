"""Node runner for Sprint 1."""
import argparse
import asyncio
import secrets
import time

from sprint1.src.config import Config
from sprint1.src.network.discovery import DiscoveryService
from sprint1.src.network.peer_table import PeerTable
from sprint1.src.network.tcp_server import TCPServer
...
def main() -> int:
    ...
    node = Sprint1Node(port=args.port)
    try:
