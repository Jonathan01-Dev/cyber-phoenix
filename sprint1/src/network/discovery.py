...
from sprint1.src.config import Config, PacketType
from sprint1.src.network.packet import ArchipelPacket, PacketBuilder
from sprint1.src.network.peer_table import PeerTable
from sprint1.src.network.tlv import encode_tlv
from sprint1.src.config import TLVType
...
class DiscoveryService:
    ...
    async def _send_hello_loop(self) -> None:
        while self.running:
            ...
            self.sock.sendto(packet, (self.config.MULTICAST_ADDR, self.config.MULTICAST_PORT))
